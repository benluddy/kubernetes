...
func TestClientAdapterEnabled(t *testing.T) {
	...
	a := newClientAdapter[clientfeatures.Feature, clientfeatures.FeatureSpec](fg, clientfeatures.Alpha, clientfeatures.Beta, clientfeatures.GA, clientfeatures.Deprecated)
	if !a.Enabled("Foo") {
