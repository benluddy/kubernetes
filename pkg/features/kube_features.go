...
func init() {
	...
	ca := newClientAdapter[clientfeatures.Feature, clientfeatures.FeatureSpec](
		utilfeature.DefaultMutableFeatureGate,
		clientfeatures.Alpha, clientfeatures.Beta, clientfeatures.GA, clientfeatures.Deprecated,
	)
