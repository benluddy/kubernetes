...
// ### discovery and openapi depend on this interface being implemented for multi-kind/single-type
...
func newMultiKindTestServer(t *testing.T) (*httptest.Server, schema.GroupVersion) {
	...
	// F0806 13:38:16.417302  805429 openapi.go:46] Failed to build open api spec for root: duplicate Operation ID listTestgroupV1NamespacedFoo for path
	//   /apis/testgroup/v1/namespaces/{namespace}/bars and /apis/testgroup/v1/namespaces/{namespace}/foos
	// s.PrepareRun()
